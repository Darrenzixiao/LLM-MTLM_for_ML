    ...
    for epoch in range(1, configs.epochs+1):
        ...
        with torch.no_grad():
            ...
            if configs.split == 'split10':
                test_ec, test_e, test_c, doc_id_all, doc_couples_all, doc_couples_pred_all = inference_one_epoch(configs, test_loader, model)
                print("doc_id_all:",doc_id_all)
                print("doc_couples_all:",doc_couples_all)
                print("doc_couples_pred_all:",doc_couples_pred_all)
        ...
        if (epoch + 1) % save_every == 0:
            torch.save(model.state_dict(), 'model_params_{}.pt'.format(epoch + 1))
