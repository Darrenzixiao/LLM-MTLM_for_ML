...
parser.add_argument('--split', '-sp', type=str, default='split20', help='batch size')
...
if __name__ == '__main__':
    ...
    for key, values in metric_folds.items():
        ...
        save_data = pd.concat([save_data, new_row], ignore_index=True)
        save_data.to_excel(excel_writer=writer, index=None, sheet_name=key)
    #writer.save()
    writer.close()
